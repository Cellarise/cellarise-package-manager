...
const createOrUpdateEnvironment = function (context, credentials, subscriptionId, websiteName, updateMode, callback) {
  ...
  azureEnvTemplate.siteConfig.connectionStrings[0].connectionString = getDbPrimaryConnectionString(context);
  azureEnvTemplate.siteConfig.connectionStrings[1].connectionString = getDbBackupConnectionString(context);
